      ...
      <header className="fixed top-2 sm:top-3 left-0 right-0 z-50 px-2 sm:px-4 max-w-7xl mx-auto">
        <nav className="cyber-panel-nav px-3.5 sm:px-5 py-2.5 sm:py-3 flex items-center justify-between">
          ...
          <div className="hidden sm:flex items-center gap-3">
            <button
              onClick={toggleLang}
              className="cyber-badge px-3 py-1.5 text-xs font-extrabold flex items-center gap-1.5 hover:bg-[#74E600] hover:text-black transition-all font-tech"
            >
          ...
          <div className="flex sm:hidden items-center gap-2">
            <button onClick={toggleLang} className="cyber-badge px-2.5 py-1 text-[10px] font-extrabold font-tech">
              {lang === 'en' ? 'AR' : 'EN'}
            </button>
